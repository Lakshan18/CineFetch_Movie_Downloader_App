                                  ...
                                  child: ElevatedButton(
                                    onPressed: isLoading
                                        ...
                                        : () async {
                                            ...
                                            await UserRegisterProcess().registerWithFirestore(
                                              context,
...
//           email.isEmpty ||
//           password.isEmpty ||
//           confPassowrd.isEmpty) {
//         CustomMessage.show(
//           context: context,
//           message: "Above all fields are required!.Please check again..!",
//           type: MessageType.error,
//         );
//         return;
//       }
...
//           context: context,
//           message:
//               "Password must be 5-10 characters and include uppercase, lowercase, number, and symbol.",
//           type: MessageType.warning,
//         );
//         return;
//       }

//       if (confPassowrd != password) {
//         CustomMessage.show(
//           context: context,
...
//       Navigator.of(
//         context,
//       ).pushReplacement(SlideFadePageRoute(page: const CreateProfileProcess()));
//     } catch (e) {
//       CustomMessage.show(
//         context: context,
...
//                                     return;
//                                     }
//                                     UserRegisterProcess().registerWithFirestore(
//                                     context,
...
//       // Create Firebase Auth user (without sending verification)
//       final auth = FirebaseAuth.instance;
//       final credential = await auth.createUserWithEmailAndPassword(
//         email: email,
//         password: password,
...
//       await FirebaseFirestore.instance
//           .collection("users") // Changed to plural for consistency
//           .doc(credential.user?.uid)
//           .set({
//             "firstName": firstName,
//             "lastName": lastName,
...
// //       // Send verification email (in real app, send code via email service)
...
// //           errorMessage = "Email/password not enabled";
// //           break;
// //         default:
// //           errorMessage = "Registration failed: ${e.code}";
// //       }
